...
public class UserDrive extends Command {
    ...
    protected void execute() 
    {
    	...
    	System.out.println("Rotations: " + (double)leftTalonSRX.getSelectedSensorPosition(0) / (4096 + gain));
    	...
    	RobotMap.netTable.putNumber("gyroRate", gyro.getRate());
    	Robot.driveBase.Drive(Robot.oi.getJoystick1());
    }
